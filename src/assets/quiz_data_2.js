export const sentences = [
    ...
    //     words: ["Wisdom", "easily", "hiding", "bed", "saucepan", "head"],
    //     shuffleWords: ["easily", "Wisdom", "saucepan", "hiding", "head", "bed"]
    // },
    // {
    //     sentence: "If you don't like toenails, you probably shouldn't look at your feet",
    //     words: ["like", "toenails", "probably", "look", "feet"],
    //     shuffleWords: ["toenails", "look", "probably", "feet", "like"]
    // },
    // {
    //     sentence: "They desperately needed another drummer since the current one only knew how to play bongos",
    //     words: ["desperately", "another", "drummer", "current", "knew", "bongos"],
    //     shuffleWords: ["another", "current", "desperately", "drummer", "bongos", "knew"]
    // }
]